...
export class PanturrilhasService {
private sheetyApiUrl = 'https://api.sheety.co/129fd1f83f6798ca5c4ea7b7cf138bed/musclePanturrilha/panturrilha';
private historyApiUrl = 'https://api.sheety.co/129fd1f83f6798ca5c4ea7b7cf138bed/musclePanturrilha/usuario';

constructor(private http: HttpClient) {}

getExercises(): Observable<any[]> {
  return this.http.get<{ panturrilha: any[] }>(this.sheetyApiUrl).pipe(
    map(response => response.panturrilha)
  );
}
