...
@Component({
  selector: 'app-panturrilhas',
  standalone: true,
  imports: [CommonModule, HttpClientModule, FormsModule, RouterModule],
  templateUrl: './panturrilhas.component.html',
  styleUrl: './panturrilhas.component.css',
  providers: [PanturrilhasService]
 
})
export class PanturrilhasComponent {
exercises: any[] = [];
  ...
  constructor(private panturrilhasService: PanturrilhasService) {}

  ngOnInit(): void {
    this.panturrilhasService.getExercises().subscribe((data) => {
      this.exercises = data;
