...
@Component({
  ...
  styleUrl: './gluteos.component.css',
  providers: [GluteosService]
})
export class GluteosComponent {
exercises: any[] = [];
  ...
  constructor(private gluteosService: GluteosService) {}

  ngOnInit(): void {
    this.gluteosService.getExercises().subscribe((data) => {
      this.exercises = data;
