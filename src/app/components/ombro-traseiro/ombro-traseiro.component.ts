...
@Component({
  selector: 'app-ombro-traseiro',
  standalone: true,
   imports: [CommonModule, HttpClientModule, FormsModule, RouterModule],
  templateUrl: './ombro-traseiro.component.html',
  styleUrl: './ombro-traseiro.component.css',
   providers: [OmbroTraseiroService]
})
export class OmbroTraseiroComponent {
exercises: any[] = [];
  ...
  constructor(private ombroTraseiroService: OmbroTraseiroService) {}

  ngOnInit(): void {
    this.ombroTraseiroService.getExercises().subscribe((data) => {
      this.exercises = data;
