...
private sheetyApiUrl = 'https://api.sheety.co/129fd1f83f6798ca5c4ea7b7cf138bed/musclePosteriorCoxa/coxa';
private historyApiUrl = 'https://api.sheety.co/129fd1f83f6798ca5c4ea7b7cf138bed/musclePosteriorCoxa/usuario';

constructor(private http: HttpClient) {}

getExercises(): Observable<any[]> {
  return this.http.get<{ coxa: any[] }>(this.sheetyApiUrl).pipe(
    map(response => response.coxa)
  );
}
