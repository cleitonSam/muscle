...
@Component({
  selector: 'app-posterior-coxa',
  standalone: true,
  imports: [CommonModule, HttpClientModule, FormsModule, RouterModule],
  templateUrl: './posterior-coxa.component.html',
  styleUrl: './posterior-coxa.component.css',
  providers: [PosteriorCoxaService]
})
export class PosteriorCoxaComponent {
exercises: any[] = [];
  ...
  constructor(private posteriorCoxaService: PosteriorCoxaService) {}

  ngOnInit(): void {
    this.posteriorCoxaService.getExercises().subscribe((data) => {
      this.exercises = data;
