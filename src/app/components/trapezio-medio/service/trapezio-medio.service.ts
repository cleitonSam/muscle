...
export class TrapezioMedioService {
private sheetyApiUrl = 'https://api.sheety.co/129fd1f83f6798ca5c4ea7b7cf138bed/muscleTrapezioMedio/trapezio';
private historyApiUrl = 'https://api.sheety.co/129fd1f83f6798ca5c4ea7b7cf138bed/muscleTrapezioMedio/usuario';

constructor(private http: HttpClient) {}

getExercises(): Observable<any[]> {
  return this.http.get<{ trapezio: any[] }>(this.sheetyApiUrl).pipe(
    map(response => response.trapezio)
  );
}
