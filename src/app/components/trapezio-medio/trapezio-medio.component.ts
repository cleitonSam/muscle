...
@Component({
  selector: 'app-trapezio-medio',
  standalone: true,
  imports: [CommonModule, HttpClientModule, FormsModule, RouterModule],
  templateUrl: './trapezio-medio.component.html',
  styleUrl: './trapezio-medio.component.css',
   providers: [TrapezioMedioService]
})
export class TrapezioMedioComponent {
exercises: any[] = [];
  ...
  constructor(private trapezioMedioService: TrapezioMedioService) {}

  ngOnInit(): void {
    this.trapezioMedioService.getExercises().subscribe((data) => {
      this.exercises = data;
