...
export class QuadricepsService {
private sheetyApiUrl = 'https://api.sheety.co/129fd1f83f6798ca5c4ea7b7cf138bed/muscleQuadriceps/quadriceps';
private historyApiUrl = 'https://api.sheety.co/129fd1f83f6798ca5c4ea7b7cf138bed/muscleQuadriceps/usuario';

constructor(private http: HttpClient) {}

getExercises(): Observable<any[]> {
  return this.http.get<{ quadriceps: any[] }>(this.sheetyApiUrl).pipe(
    map(response => response.quadriceps)
  );
}
