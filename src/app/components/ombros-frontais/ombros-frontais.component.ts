...
export class OmbrosFrontaisComponent {
exercises: any[] = [];
  ...
  constructor(private ombrosFrontaisService: OmbrosFrontaisService) {}

  ngOnInit(): void {
    this.ombrosFrontaisService.getExercises().subscribe((data) => {
      this.exercises = data;
